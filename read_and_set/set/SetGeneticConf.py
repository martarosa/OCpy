...
class SetGeneticOCInput(ABCSetInput):
    ...
    def set(self, user_input):
        ...
        self.input_parameters.parallel = user_input.genetic.section_dictionary['parallel']
        self.input_parameters.initial_guess = user_input.genetic.section_dictionary['initial_guess']

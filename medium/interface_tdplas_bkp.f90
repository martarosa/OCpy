module interface_tdplas
      ...
      !public print_cose, init_global_tdplas, prop_charges !init_charges, prop_charges, prepare_potentials 
...
!
!
!            subroutine call_prop_charges(ci, field_vector, n_states, q_t)
!                complex*16, intent(in) :: ci(n_states)
!                real*8, dimension(3), intent(in) :: field_vector
!                integer :: n_states
!                real*8, intent(inout) :: q_t
...
!           end subroutine
            ...
            subroutine prepare_potentials(ci, field_vector, V_reactionf, V_localf, n_states, n_tessere)
                ...
                do i=1, pedra_surf_n_tessere
                    V_localf(i) = field_vector(1)*pedra_surf_tessere(i)%x + &
